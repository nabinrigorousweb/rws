 ...
 * Description:
 * Categories: entrepreneurship/card, entrepreneurship/call-to-action
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore Entrepreneurship</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Entrepreneurship is a block theme for the next generation of WordPress creators. With beautiful patterns and templates built right in, you can get a site launched in record time.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p style="font-style:normal;font-weight:600">“Working with Entrepreneurship has been a delight from start to finish.”</p>
<!-- /wp:paragraph -->
...
<h4 class="wp-block-heading has-base-color has-text-color">Download Entrepreneurship</h4>
<!-- /wp:heading -->
...
<p class="has-base-color has-text-color">Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Entrepreneurship block theme. Anyone can do it! No coding skills required.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-primary-color has-base-background-color has-text-color has-background wp-element-button" href="https://wpwheels.com">Download Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
