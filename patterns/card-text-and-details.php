 ...
 * Description:
 * Categories: entrepreneurship/call-to-action, entrepreneurship/features, entrepreneurship/card
...
<h2 class="wp-block-heading has-base-color has-text-color">Download Entrepreneurship for free today and start building</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"main-accent"} -->
<p class="has-main-accent-color has-text-color">Entrepreneurship ships with a growing collection of design patterns that cohesively click together. Drag, drop, mix, and match patterns to create stunning designs in just a few minutes. </p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button">Download Entrepreneurship</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
