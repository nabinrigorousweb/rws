...
<!-- wp:paragraph -->
<p>Your website deserves to look pixel-perfect on every device. Entrepreneurship ensures your entire design scales down gracefully automagically.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p>We obsess over performance so you don’t have to. Entrepreneurship is super lightweight and scores top marks on Google PageSpeed Insights.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
